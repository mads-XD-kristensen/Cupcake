...
<style>
    ...
    <body>
<div ><img src="images/olskercupcakes.png" class="pic"></div>


       <div style="background-color: #c6c8d1; border-radius: 20px; width: auto; height: auto"> <br><h1 class="text">Velkommen til Olsker cupcakes</h1>
<br>
